...
## [12.0.0](https://github.com/KurisuNya/lazy.nvim/compare/v11.4.1...v12.0.0) (2024-06-26)
...
* added `Pre` events. Fixes [#856](https://github.com/KurisuNya/lazy.nvim/issues/856). Fixes [#877](https://github.com/KurisuNya/lazy.nvim/issues/877) ([0bca18d](https://github.com/KurisuNya/lazy.nvim/commit/0bca18de5d005c700c29da580c20c762c2f9e9e0))
* added support for local spec files `.lazy.lua` ([9dde1f1](https://github.com/KurisuNya/lazy.nvim/commit/9dde1f1bce44a8fd8cb885b5a8e8d47d8fd7b8c1))
* added support for plugin packages by lazy, rockspec and packspec ([3be55a4](https://github.com/KurisuNya/lazy.nvim/commit/3be55a46158cde17e2b853e531d260f3738a5346))
* **build:** added support for build.lua, build/init.lua ([#903](https://github.com/KurisuNya/lazy.nvim/issues/903)) ([4c26421](https://github.com/KurisuNya/lazy.nvim/commit/4c26421785be8c49f1d8eaa5bdb55b73c7be5127))
* **build:** build files and functions are now async. use coroutine.yield to interrupt and report progress ([368747b](https://github.com/KurisuNya/lazy.nvim/commit/368747bc9a314b4f0745547ebdcc3fbc4d100c0a))
* change default hover key ([af5b824](https://github.com/KurisuNya/lazy.nvim/commit/af5b824eaf99f6b07caf9225c2d9121fc5b169a6))
* **cmd:** added `Lazy load all` to load all plugins ([11131ea](https://github.com/KurisuNya/lazy.nvim/commit/11131eafa165e54b08aeff3d7e35c65ef8b6e034))
* **commands:** added highly experimental `Lazy reload ...` command. See [#445](https://github.com/KurisuNya/lazy.nvim/issues/445) ([a6c8f22](https://github.com/KurisuNya/lazy.nvim/commit/a6c8f22362dccf5416ccb108f201e9f1ddda43f1))
* **event:** added support for structured events (see readme on event) ([303a3ed](https://github.com/KurisuNya/lazy.nvim/commit/303a3ed6a874bb5bdebf11ecdf99e1dfa3eed2c3))
* **event:** custom lazy event hook for distros ([b65d308](https://github.com/KurisuNya/lazy.nvim/commit/b65d3086623448b93bf02055f73819b76ca1dd78))
* find local_spec in parent directories as well. Closes [#1519](https://github.com/KurisuNya/lazy.nvim/issues/1519) ([e2e10d9](https://github.com/KurisuNya/lazy.nvim/commit/e2e10d9cbe133265ccdcc44cafa7c10773d96837))
* **float:** floats can now be persistent ([94472b8](https://github.com/KurisuNya/lazy.nvim/commit/94472b8303f4db496ff1214a73aa8f600e375974))
* **git:** change default log args to last 8 ([49a7f21](https://github.com/KurisuNya/lazy.nvim/commit/49a7f21ee37b4f8a13f6774b17ddfcae5e4f41b0))
* **git:** show error for local changes during check/update ([43e9165](https://github.com/KurisuNya/lazy.nvim/commit/43e9165994d76038bd6ebd2d06830a7204ae74e0))
* **git:** show help on how to remove local changes ([58e5726](https://github.com/KurisuNya/lazy.nvim/commit/58e5726592a3f4a83735edfea996911d8daea002))
* **keys:** include custom keys in help menu ([#1105](https://github.com/KurisuNya/lazy.nvim/issues/1105)) ([43c284a](https://github.com/KurisuNya/lazy.nvim/commit/43c284a57870e1a7ed42782eacf444a6a752f81e))
* **keys:** refactor code and allow disabling keymaps per mode. mode no longer needs to be exactly the same in order to disable. ([b79099c](https://github.com/KurisuNya/lazy.nvim/commit/b79099cc9d768241162bb45d284d6a243736b9fb))
* **keys:** you can now create buffer-local filetype keymaps by specifying `ft=`. Fixes [#1076](https://github.com/KurisuNya/lazy.nvim/issues/1076) ([c42e63c](https://github.com/KurisuNya/lazy.nvim/commit/c42e63c1986af6ba417d9c2a0062ac41f79df18b))
* **loader:** `LazyLoad` event with plugin name as `data` field. Useful to do stuff when a plugin loads ([ea5b2e0](https://github.com/KurisuNya/lazy.nvim/commit/ea5b2e00bf7aeaaf10a4e93763419e4af2796782))
* **loader:** added explicit support for finding the main module for mini.nvim plugins ([dab6cd5](https://github.com/KurisuNya/lazy.nvim/commit/dab6cd50806d6a6b0e8267f628d5fd6b112b151c))
* **loader:** warn when maplocalleader is changed after init ([#1326](https://github.com/KurisuNya/lazy.nvim/issues/1326)) ([0694651](https://github.com/KurisuNya/lazy.nvim/commit/0694651fd37c3645e1683b4f392d4e38e7d2991b))
* **loader:** when reloading, always re-source loaded vimscript files. See [#445](https://github.com/KurisuNya/lazy.nvim/issues/445) ([d8a5829](https://github.com/KurisuNya/lazy.nvim/commit/d8a5829fdad1d435fd74d65743df5d53d4a845d2))
* luarocks support ([f1ba2e3](https://github.com/KurisuNya/lazy.nvim/commit/f1ba2e3d057ae5c03d04134a9d538d0b2251f13b))
* make it easier to disable luarocks ([07c067a](https://github.com/KurisuNya/lazy.nvim/commit/07c067a1a82bb0988179e1887bba9df4721b3ea7))
* **meta:** check for dir changes for plugins already added to the rtp ([ee2ca39](https://github.com/KurisuNya/lazy.nvim/commit/ee2ca39f672a2d6f4cbb683b525e6b3d91f3fc0c))
* new docs for v11.0 ([183f59e](https://github.com/KurisuNya/lazy.nvim/commit/183f59e2e85dea0c38ed7d16c7c7e543c0b739c7))
* packspec ([8eba74c](https://github.com/KurisuNya/lazy.nvim/commit/8eba74c3fc41e1a364225f744022f8b3ff11d796))
* **pkg:** import package specs in the scope of the plugin ([c1912e2](https://github.com/KurisuNya/lazy.nvim/commit/c1912e23481ba72a8d8f7a5c736f5e2547e6853e))
* **pkg:** utils to get rock to url mappings ([be74a8a](https://github.com/KurisuNya/lazy.nvim/commit/be74a8a535fea6a480143fb52b4d6958d9e2da94))
* **plugin:** `cond` is now the same as `enabled`, but skips clean ([fbb0bea](https://github.com/KurisuNya/lazy.nvim/commit/fbb0bea2db1963b4b83a3cb1f0c09d78a2ab286f))
* **plugin:** `opts_extend` can be a list of dotted keys that will be extended instead of merged ([1f7b720](https://github.com/KurisuNya/lazy.nvim/commit/1f7b720cffa6d8f00ebb040bc60e8e056e0a6002))
* **plugin:** added support for `cond` for imports ([#1079](https://github.com/KurisuNya/lazy.nvim/issues/1079)) ([58e954a](https://github.com/KurisuNya/lazy.nvim/commit/58e954a735767fd23c24c455dc09c5323951ec83))
* **plugin:** added support for `weak` specs. They will not be included in the final spec if not specified somwhere else ([8564f6d](https://github.com/KurisuNya/lazy.nvim/commit/8564f6d22b78a4a0fba9811faa556159b6c90a49))
* **plugin:** dev.path can now be a function ([#1157](https://github.com/KurisuNya/lazy.nvim/issues/1157)) ([a6f782a](https://github.com/KurisuNya/lazy.nvim/commit/a6f782adc1ace840a7e671c731daab7851cba6af))
* **plugin:** dont include plugin spec fragments for disabled or optional plugins ([#1058](https://github.com/KurisuNya/lazy.nvim/issues/1058)) ([f3c7169](https://github.com/KurisuNya/lazy.nvim/commit/f3c7169dd65f5ae528b6c930492359971014290b))
* **plugin:** keep track of the module a spec fragment was defined in ([8eb8de2](https://github.com/KurisuNya/lazy.nvim/commit/8eb8de29af6e2ab9dd7986e2521178875dbcad95))
* **plugins:** Given an optional plugin, conditionally discard deps ([#947](https://github.com/KurisuNya/lazy.nvim/issues/947)) ([e7334d8](https://github.com/KurisuNya/lazy.nvim/commit/e7334d8db5bab48463f8ab3ea020bf2f76aaa7f9))
* **plugin:** treat url changes as warnings. They will only be shown with checkhealth ([0c53d46](https://github.com/KurisuNya/lazy.nvim/commit/0c53d4673ff02c57a192558325b394cfd9adde0f))
* **plugin:** trigger LazyPlugins after loading plugin specs ([57062f3](https://github.com/KurisuNya/lazy.nvim/commit/57062f3a09cad6dd5fe745389ad9f8421e3bdcd2))
* **profiling:** added options to enable additional profiling ([423a152](https://github.com/KurisuNya/lazy.nvim/commit/423a152e94db37dd535d56e6cb6f06b282c5f081))
* refactor all vim.loop -&gt; vim.uv and add a shim when needed ([9e157df](https://github.com/KurisuNya/lazy.nvim/commit/9e157df077d24654d0cdefe08158cd4f76e85fe8))
* rewrite of spec resolving ([75ffe56](https://github.com/KurisuNya/lazy.nvim/commit/75ffe56f70faac43f077796b91178d2f1419f8ce))
* rewrite some known plugins to lazy specs instead of luarocks (plenary.nvim). Closes [#1540](https://github.com/KurisuNya/lazy.nvim/issues/1540) ([a089d43](https://github.com/KurisuNya/lazy.nvim/commit/a089d43dba7438532c56e1c582c5974713bd48f8))
* **rocks:** simple rockspecs are now fully resolved by lazy without luarocks. See [#1548](https://github.com/KurisuNya/lazy.nvim/issues/1548) ([6b8bf58](https://github.com/KurisuNya/lazy.nvim/commit/6b8bf58ebf9114f8f31fb78cbf057e452cb0e540))
* **rocks:** use hererocks to install luarocks when luarocks is not found ([d87da76](https://github.com/KurisuNya/lazy.nvim/commit/d87da7667939deff2ed8b5a3c198d9ea2e03fee4))
* set `vim.env.LAZY` to lazy root ([6a141a6](https://github.com/KurisuNya/lazy.nvim/commit/6a141a6dbb6f6b5495ef6716c0dce898546d7b2c))
* show rockspec deps in plugin details ([656d3d1](https://github.com/KurisuNya/lazy.nvim/commit/656d3d1f5b5910e50af3d67286999ff7088ebfb6))
* single-plugin keys in the lazy view in visual mode ([#1476](https://github.com/KurisuNya/lazy.nvim/issues/1476)) ([7667a73](https://github.com/KurisuNya/lazy.nvim/commit/7667a73dee381c5fb7d538f6152aeb591e3f0372))
* spec.rocks is no longer needed & added support for installing any luarock ([fcfd548](https://github.com/KurisuNya/lazy.nvim/commit/fcfd54835da5af64c6046060f4db62c4626d209c))
* **startup:** added data/site to the rtp. Will be used by upcoming treesitter version ([f131606](https://github.com/KurisuNya/lazy.nvim/commit/f131606190535b0d0b35406e8573b973b48e55b1))
* **ui:** add style to dimmed commits ([#1210](https://github.com/KurisuNya/lazy.nvim/issues/1210)) ([7ded44c](https://github.com/KurisuNya/lazy.nvim/commit/7ded44ce2a442aa32b90488b8f1f9c8ca6899f3b))
* **ui:** added support for setting a title of the lazy window. Fixes [#814](https://github.com/KurisuNya/lazy.nvim/issues/814) ([9dce081](https://github.com/KurisuNya/lazy.nvim/commit/9dce0816f15f478c864c65fce0cd55f145faad03))
* **ui:** backdrop for the lazy floating window. Can be disabled with `opts.ui.backdrop` ([a6b74f3](https://github.com/KurisuNya/lazy.nvim/commit/a6b74f30d5aab79a40d932f449c0aa5d4a0c6934))
* **ui:** check pinned packages that can't be updated ([#1139](https://github.com/KurisuNya/lazy.nvim/issues/1139)) ([4446fdb](https://github.com/KurisuNya/lazy.nvim/commit/4446fdb9af1b1c41560f6cc41452eee826a8bce0))
* **ui:** show the loaded icon for local plugins in a different color ([96dd205](https://github.com/KurisuNya/lazy.nvim/commit/96dd2058fb5427d87589825ad6001ad017548e81))
* **util:** expose pretty stacktraces for notify ([7b84609](https://github.com/KurisuNya/lazy.nvim/commit/7b84609a06bd11869370bc20a9255bb469e35a50))
* **util:** option to force system app for util.open ([66466a2](https://github.com/KurisuNya/lazy.nvim/commit/66466a2594ab0c446193772a68c236c7e4e02ade))
* **util:** opts merging now supports lists extending by tagging a table with __extend = true. Use with care ([74fd361](https://github.com/KurisuNya/lazy.nvim/commit/74fd3611f291a2506c5534109689bb7b028f0566))
* **view:** add option `ui.pills`. Set to `false` to disable the top buttons in the lazy window ([#938](https://github.com/KurisuNya/lazy.nvim/issues/938)) ([84266b9](https://github.com/KurisuNya/lazy.nvim/commit/84266b9f0ff314319e69adfeb1a86bd72d1aff91))


### Bug Fixes

* better weak handling ([af39d61](https://github.com/KurisuNya/lazy.nvim/commit/af39d61d3f32683b6e9962d64ab269330b456172))
* **build:** allow `build` command to override plugin's build and option to disable warning ([189371c](https://github.com/KurisuNya/lazy.nvim/commit/189371c8d8ac8205687522dd4c3601edc7b7a927))
* **build:** allow build=false to skip building ([314193a](https://github.com/KurisuNya/lazy.nvim/commit/314193af1d63181bff65e8b24db416e34c5fae86))
* **cache:** vim.loop fallback ([#1375](https://github.com/KurisuNya/lazy.nvim/issues/1375)) ([9131ea4](https://github.com/KurisuNya/lazy.nvim/commit/9131ea4c4ae59e347716659088a76d9b9ce3b2f5))
* **checker:** ignore dev plugins ([#1384](https://github.com/KurisuNya/lazy.nvim/issues/1384)) ([2e04a0c](https://github.com/KurisuNya/lazy.nvim/commit/2e04a0c02c17facd3772c382099215acbe72535b))
* **cmd:** lazy-cmds no longer show an error for buffer-local commands ([3b31897](https://github.com/KurisuNya/lazy.nvim/commit/3b31897275d5c09e2654db1c163b87eb383ca25e))
* **cmd:** shedule error message instead of showing directly ([03419f3](https://github.com/KurisuNya/lazy.nvim/commit/03419f3e5f7590194d599aa8a1a7a7841409d141))
* **commands:** completion error ([#819](https://github.com/KurisuNya/lazy.nvim/issues/819)) ([f125a7d](https://github.com/KurisuNya/lazy.nvim/commit/f125a7d333472ada244b4564805ba11be3c269a9))
* **config:** on windows default concurrency is now set to 2*available parallelism. See [#887](https://github.com/KurisuNya/lazy.nvim/issues/887) ([d7d5842](https://github.com/KurisuNya/lazy.nvim/commit/d7d5842d1c9a566d480db8b4a5aaf00054b99bb5))
* **config:** use url_format for the lazy plugin ([#792](https://github.com/KurisuNya/lazy.nvim/issues/792)) ([d2d67b5](https://github.com/KurisuNya/lazy.nvim/commit/d2d67b5a0ba90a33eeae0a1a661249b26754143b))
* **debug:** show original keymaps instead of ids for the keys handler ([56b1f77](https://github.com/KurisuNya/lazy.nvim/commit/56b1f7715ed536a3e9ebfbf0d26e615d211a0cd8))
* **docs:** broken table in readme ([#1097](https://github.com/KurisuNya/lazy.nvim/issues/1097)) ([89581ce](https://github.com/KurisuNya/lazy.nvim/commit/89581ce37e1252133725cb583b5ba4fa0a827270))
* **event:** better dealing with even handlers. Fixes [#788](https://github.com/KurisuNya/lazy.nvim/issues/788) ([ef2a5d0](https://github.com/KurisuNya/lazy.nvim/commit/ef2a5d0bd1a4995539b93be69fc760be7d9f62be))
* **event:** dont use autocmd pattern to detect event retriggering. Fixes [#858](https://github.com/KurisuNya/lazy.nvim/issues/858) ([bc89502](https://github.com/KurisuNya/lazy.nvim/commit/bc895023573e76f8567d2375bbd3ea8be4f00ca7))
* **event:** move all ft logic to the event handler ([8871602](https://github.com/KurisuNya/lazy.nvim/commit/8871602e541c9c7ecd036d631b527454312f88b2))
* **event:** pass data to event lazy loaders. Fixes [#922](https://github.com/KurisuNya/lazy.nvim/issues/922) ([fd94e69](https://github.com/KurisuNya/lazy.nvim/commit/fd94e69ceb15268496b85ee61fcd55a08539df1d))
* **event:** prevent loading event handler more than once in some cases ([6b37927](https://github.com/KurisuNya/lazy.nvim/commit/6b37927be9e0166ddb4445023904345d88045497))
* **event:** use tbl_contains instead of list_contains ([2b2adb9](https://github.com/KurisuNya/lazy.nvim/commit/2b2adb9d4d6ccd469b1e82416c58ea74fe5a0e1b))
* **float:** disable swapfile for files shown in Float ([3769461](https://github.com/KurisuNya/lazy.nvim/commit/37694611946387dc79d546bdc193bc8611ac1c6d))
* force new release ([9242edb](https://github.com/KurisuNya/lazy.nvim/commit/9242edb73939e7508dbd827e9c013579391f0668))
* **fragments:** check for empty plugin names ([dea1f68](https://github.com/KurisuNya/lazy.nvim/commit/dea1f687fe6e15eb3098557a69d44231ebcb6cf5))
* **fragments:** prevent adding the same spec instance more than once ([dbffad6](https://github.com/KurisuNya/lazy.nvim/commit/dbffad6f44674a3c1b23c649a0abab299d7349d8))
* **fs:** error when plugin directory to delete is not a valid directory ([47d4baa](https://github.com/KurisuNya/lazy.nvim/commit/47d4baafcc370f16c195fd718f37f8fb1e0aa9a1))
* **ft:** fix ft handlers to properly use new events. Fixes [#1084](https://github.com/KurisuNya/lazy.nvim/issues/1084) ([e4ea874](https://github.com/KurisuNya/lazy.nvim/commit/e4ea874e33fd3116d0e113f4b03eff2d6b1e3399))
* **git:** automatically restore doc/tags when modified ([736529d](https://github.com/KurisuNya/lazy.nvim/commit/736529d097979b3585cbc8e2728543fde9b314ed))
* **git:** comment sign detection in get_config function ([#1281](https://github.com/KurisuNya/lazy.nvim/issues/1281)) ([d0d410b](https://github.com/KurisuNya/lazy.nvim/commit/d0d410bc222a475202d9c2b55d1c5fbd12c26ffe))
* **git:** fetch commit from origin or local to check if branch was changed. See [#1549](https://github.com/KurisuNya/lazy.nvim/issues/1549) ([28e435b](https://github.com/KurisuNya/lazy.nvim/commit/28e435b7f34eecd8b90bc87ac71c70b79fcb03b3))
* **git:** force `autocrlf=false`. Fixes [#1055](https://github.com/KurisuNya/lazy.nvim/issues/1055) ([d2a4ce2](https://github.com/KurisuNya/lazy.nvim/commit/d2a4ce22dc02aa08c176cd7692b5b0ed74e4722b))
* **git:** unset GIT_INDEX_FILE so we dont accidentally overwrite a different git repo. Fixes [#1107](https://github.com/KurisuNya/lazy.nvim/issues/1107) ([7f70dd1](https://github.com/KurisuNya/lazy.nvim/commit/7f70dd17497973f2a83e7e46aa7479111174e765))
* **health:** added luarocks check to health ([0f45c0d](https://github.com/KurisuNya/lazy.nvim/commit/0f45c0d0623b4850716898a5e399c844466690f6))
* **health:** dont warn on submodules. Fixes [#1174](https://github.com/KurisuNya/lazy.nvim/issues/1174) ([1b3df6c](https://github.com/KurisuNya/lazy.nvim/commit/1b3df6c00797e1b12f7c16148261e9dd841a33dd))
* **health:** false warning when checking plugins configured with 'optional' key ([#897](https://github.com/KurisuNya/lazy.nvim/issues/897)) ([24803fc](https://github.com/KurisuNya/lazy.nvim/commit/24803fcbe3fe2c84300903278b7445cfb2e54deb))
* **health:** only check for luarocks when luarocks is enabled. ([ae4881d](https://github.com/KurisuNya/lazy.nvim/commit/ae4881d36e7f589124f8eb7febfc6a8b58f8e027))
* **health:** show missing luarocks as warning ([e3ee51b](https://github.com/KurisuNya/lazy.nvim/commit/e3ee51b6680a116649da56f6c651d53c3e47be4e))
* **health:** show what plugins need luarocks and if none, use warnings instead of errors. See [#1551](https://github.com/KurisuNya/lazy.nvim/issues/1551) ([0d9fd63](https://github.com/KurisuNya/lazy.nvim/commit/0d9fd636beb9e3783edcdba2b31932280bdc05f7))
* **heath:** vim.uv. Fixes [#1412](https://github.com/KurisuNya/lazy.nvim/issues/1412) ([481aed7](https://github.com/KurisuNya/lazy.nvim/commit/481aed70cc4d8e8a38463fd16edf81a23c153247))
* **help:** get rid of any tbl_flatten or iter flatten code ([56a34a8](https://github.com/KurisuNya/lazy.nvim/commit/56a34a825b55e0e30cd9df0e055e428a13afd4aa))
* **help:** sort readme tags case sensitive. Fixes [#67](https://github.com/KurisuNya/lazy.nvim/issues/67) ([54ecfc7](https://github.com/KurisuNya/lazy.nvim/commit/54ecfc7c245e5e3fbbc749658ad171335418d48c))
* **keys:** allow global/local ft keymaps to exist at the same time. Fixes [#1241](https://github.com/KurisuNya/lazy.nvim/issues/1241) ([5757b55](https://github.com/KurisuNya/lazy.nvim/commit/5757b551fc6066d836b9e45f70b41561ca619272))
* **keys:** buffer-local nop mappings ([ff90417](https://github.com/KurisuNya/lazy.nvim/commit/ff904178089582f90fdc625493f3d3bddbefd6ea))
* **keys:** fix abbreviation expansion on lazy load ([#1219](https://github.com/KurisuNya/lazy.nvim/issues/1219)) ([d09084c](https://github.com/KurisuNya/lazy.nvim/commit/d09084c4b1f5c58724152a4acad7c880117a95ea))
* **keys:** fixed adding managed keys ([9d92e65](https://github.com/KurisuNya/lazy.nvim/commit/9d92e65fd17d35f97bed43dc92810576a57376fc))
* **keys:** fixed buffer-local mappings ([09e30f8](https://github.com/KurisuNya/lazy.nvim/commit/09e30f88cd4b47704005c41f0486a628b0b8d774))
* **keys:** make sure we don't delete the global mapping when executing an ft keymap. See [#1241](https://github.com/KurisuNya/lazy.nvim/issues/1241) ([a9b9a4b](https://github.com/KurisuNya/lazy.nvim/commit/a9b9a4b3a2dcc1e81828cfd74bfb61193b014b67))
* **keys:** never lazy-load `&lt;nop&gt;` or empty rhs keymaps ([3e4c795](https://github.com/KurisuNya/lazy.nvim/commit/3e4c795cec32481bc6d0b30c05125fdf7ef2d412))
* **keys:** properly deal with ft list for keys. Fixes [#1448](https://github.com/KurisuNya/lazy.nvim/issues/1448) ([82cf974](https://github.com/KurisuNya/lazy.nvim/commit/82cf974e0939b3440c4470cbcd8e7869abfe480b))
* **keys:** properly re-create buffer-local mappings. Fixes [#1448](https://github.com/KurisuNya/lazy.nvim/issues/1448) ([39de11a](https://github.com/KurisuNya/lazy.nvim/commit/39de11a2fa7f4b91556631c49a673bf3e48bcc16))
* **keys:** replace term codes to calculate ids ([d65a3d6](https://github.com/KurisuNya/lazy.nvim/commit/d65a3d6755bd3f1ca7bc4c15a8acf57687b1ca51))
* **loader:** don't load handlers before installing plugins ([1cfd6d1](https://github.com/KurisuNya/lazy.nvim/commit/1cfd6d1f368ab72690e31cf4d8e15c36d8b60202))
* **loader:** don't run ftdetect twice for paths already on the rtp during startup. Fixes [#839](https://github.com/KurisuNya/lazy.nvim/issues/839) ([36a9132](https://github.com/KurisuNya/lazy.nvim/commit/36a91320f9ff4f877f09ac3a52c6a26860da047a))
* **loader:** dont autoload when lazy handlers have not been setup yet. Fixes [#1132](https://github.com/KurisuNya/lazy.nvim/issues/1132) ([daab5fe](https://github.com/KurisuNya/lazy.nvim/commit/daab5fe2807c55867d5f7cfb6ef0944783361be2))
* **loader:** dont clear tasks when istalling missing plugins ([80c4dec](https://github.com/KurisuNya/lazy.nvim/commit/80c4decc3226551b433dfea5e459998a96f17822))
* **loader:** fixed event check in reload. Fixes [#1124](https://github.com/KurisuNya/lazy.nvim/issues/1124) ([cdfa788](https://github.com/KurisuNya/lazy.nvim/commit/cdfa78888159323abc931db26f3301360393fbb7))
* **loader:** getscriptinfo compat with stable. Fixes [#944](https://github.com/KurisuNya/lazy.nvim/issues/944) ([e428c5e](https://github.com/KurisuNya/lazy.nvim/commit/e428c5ee4b02dfb39203ac8745a58c1226ceebae))
* **loader:** no need to check plugin.dir in auto_load ([62a47b9](https://github.com/KurisuNya/lazy.nvim/commit/62a47b921fbffb3c1c8088a731029ae234f98851))
* **loader:** reset cache before installing plugins during startup. Fixes [#803](https://github.com/KurisuNya/lazy.nvim/issues/803) ([aecdaab](https://github.com/KurisuNya/lazy.nvim/commit/aecdaab6a6ce8c9fdf9f983d5f943c6cfb11bf61))
* **loader:** when reloading, clear plugin properties cache ([#1153](https://github.com/KurisuNya/lazy.nvim/issues/1153)) ([312e424](https://github.com/KurisuNya/lazy.nvim/commit/312e424a084a43b8b786f786b884be60043c23dc)), closes [#445](https://github.com/KurisuNya/lazy.nvim/issues/445)
* **luarocks:** cleanup luarocks when deleting a plugin ([b73c57e](https://github.com/KurisuNya/lazy.nvim/commit/b73c57ed9ec8e63bbb867d21a3f3a865224b25d4))
* **manage:** better support for using the default colorscheme during install. See [#1277](https://github.com/KurisuNya/lazy.nvim/issues/1277) ([670a6fe](https://github.com/KurisuNya/lazy.nvim/commit/670a6fec7f9b03134849e308d87f4dc316875c46))
* **manage:** prevend auto conversion 'CRLF' to 'LF' in update lazy-lock.json on Windows. Fixes [#1093](https://github.com/KurisuNya/lazy.nvim/issues/1093) ([#1094](https://github.com/KurisuNya/lazy.nvim/issues/1094)) ([5579d72](https://github.com/KurisuNya/lazy.nvim/commit/5579d72576b21b9c8c2d01838598aece5dc2be6d))
* **manage:** trigger LazySyncPre. Fixes [#881](https://github.com/KurisuNya/lazy.nvim/issues/881) ([6163413](https://github.com/KurisuNya/lazy.nvim/commit/616341372d1908bb2a11e3bf9ed55e74bf605e40))
* **meta:** no need to check for old_dir when frags were not built yet. Fixes [#1550](https://github.com/KurisuNya/lazy.nvim/issues/1550) ([24c8322](https://github.com/KurisuNya/lazy.nvim/commit/24c832213c505a0d7ca021c0e14bba43e0fef75c))
* **meta:** only tag new top-level pkg fragment as optional ([25981e1](https://github.com/KurisuNya/lazy.nvim/commit/25981e1f3927ee0b22aefea122ebac1cddafdca6))
* **pkg:** automatically update pkgs when editing a pkg file ([7b6ddbf](https://github.com/KurisuNya/lazy.nvim/commit/7b6ddbfc137ad5d8b178a3bbf5a1338630f30625))
* **pkg:** correctly pre-load package specs and remove them when needed during resolve ([4326d4b](https://github.com/KurisuNya/lazy.nvim/commit/4326d4b487d4facc19b375ca30cd633cf56d88ed))
* **pkg:** make sure state dir exists ([3515cb5](https://github.com/KurisuNya/lazy.nvim/commit/3515cb518f61c02b41cd3a8d8135c9a5862a982f))
* **pkg:** versioning and reload specs when pkg-cache is dirty ([fd8229d](https://github.com/KurisuNya/lazy.nvim/commit/fd8229d6e312e83d6bafda256adf0e650b13ca01))
* **plugin:** better way of dealing with local specs. Fixes [#1524](https://github.com/KurisuNya/lazy.nvim/issues/1524) ([be5dfba](https://github.com/KurisuNya/lazy.nvim/commit/be5dfba54216ccb80959df24d48540f07ee127a3))
* **plugin:** check optional plugins again after resolving enabled. Fixes [#1402](https://github.com/KurisuNya/lazy.nvim/issues/1402) ([067fd41](https://github.com/KurisuNya/lazy.nvim/commit/067fd41933c9f59eb3445eb942052c651a4c9a62))
* **plugin:** check that import is a string. See [#825](https://github.com/KurisuNya/lazy.nvim/issues/825) ([c325c50](https://github.com/KurisuNya/lazy.nvim/commit/c325c50ba42572b25c08330ea10ae4743ee69280))
* **plugin:** delay check if plugin ref exists until after loading all plugins. Fixes [#833](https://github.com/KurisuNya/lazy.nvim/issues/833) ([199e100](https://github.com/KurisuNya/lazy.nvim/commit/199e1004647895d5cb87911ae65e4f01418abf3b))
* **plugin:** dont allow `dir` changes when we already loaded files from the plugin's old dir. Show an error in this case. Fixes [#993](https://github.com/KurisuNya/lazy.nvim/issues/993) ([c8e2091](https://github.com/KurisuNya/lazy.nvim/commit/c8e2091e6d2836b587b9892e0fb64afaec36926a))
* **plugin:** fix url based plugin name and added extra safety checks. Fixes [#824](https://github.com/KurisuNya/lazy.nvim/issues/824) ([32170a8](https://github.com/KurisuNya/lazy.nvim/commit/32170a88916e0f18ffaf1c32b222a5e2216bdb0e))
* **plugin:** fixup. It's fine that Plugin.url doesn't exist ([42ff600](https://github.com/KurisuNya/lazy.nvim/commit/42ff6009f67a712ab4e7c8deedb626f8243a052a))
* **plugin:** improved dir/dev merging. Fixes [#993](https://github.com/KurisuNya/lazy.nvim/issues/993) ([3dc413d](https://github.com/KurisuNya/lazy.nvim/commit/3dc413d6fd279dfff777a9f9a964697a16c5aabc))
* **plugin:** prevent recursive loop with cond=false. Fixes [#1061](https://github.com/KurisuNya/lazy.nvim/issues/1061) ([09e5010](https://github.com/KurisuNya/lazy.nvim/commit/09e5010741e340eb603afbff34453dbee55b7011))
* **plugin:** rebuild optional when needed and remove frags from parent deps. Fixes [#1402](https://github.com/KurisuNya/lazy.nvim/issues/1402) ([b4316da](https://github.com/KurisuNya/lazy.nvim/commit/b4316da7310682144c279c5f0451e59ee5f6c9d1))
* **plugin:** rebuild plugins after fixing optional and cond to ensure enabled will work correctly ([638c8e6](https://github.com/KurisuNya/lazy.nvim/commit/638c8e6382f121aef983c78d865f6dbbc72d68c3))
* **plugin:** rename weak =&gt; optional. Makes more sense :) ([9177778](https://github.com/KurisuNya/lazy.nvim/commit/9177778891ecdf02562eeaa1a26b829e4b62bc16))
* **plugin:** work-around for Plugin.values error. Will add proper fix later. Fixes [#1124](https://github.com/KurisuNya/lazy.nvim/issues/1124) ([2270bbb](https://github.com/KurisuNya/lazy.nvim/commit/2270bbbc48503f468633cc5c2065321001c4f0ac))
* **process:** make sure cwd is a valid directory ([92869d0](https://github.com/KurisuNya/lazy.nvim/commit/92869d0928ad3bb1aa61cf61897a78f3faa17835))
* **profiling:** ensure proper traces in case of require errors ([2782f81](https://github.com/KurisuNya/lazy.nvim/commit/2782f8125e793940f5bf942af1a1df0bbc989d11))
* properly setup handlers when loading a plugin before startup (build) etc ([24f6b6f](https://github.com/KurisuNya/lazy.nvim/commit/24f6b6f1c7fb68f02335dd9579faee8b243e6a54))
* **reload:** strings in lua reload ([#1439](https://github.com/KurisuNya/lazy.nvim/issues/1439)) ([2fcbcaf](https://github.com/KurisuNya/lazy.nvim/commit/2fcbcaf07ab79594f2ba25ebf6f4c47e250c33be))
* **render:** disable underline for diagnostics ([#1478](https://github.com/KurisuNya/lazy.nvim/issues/1478)) ([ea7b9c3](https://github.com/KurisuNya/lazy.nvim/commit/ea7b9c3c3fd9026e1a5ae27950585df9a42ccd5b))
* return true when opening diff ([#970](https://github.com/KurisuNya/lazy.nvim/issues/970)) ([0e1d264](https://github.com/KurisuNya/lazy.nvim/commit/0e1d264ab6567725b6c30ffd1ad120b16884ff45))
* **rocks:** better errors / warnings when something goes wrong with luarocks ([7d3f691](https://github.com/KurisuNya/lazy.nvim/commit/7d3f69104fb39d3e6e12f808204b3a7b38f86916))
* **rocks:** build.type instead of build.build_type ([aa1c957](https://github.com/KurisuNya/lazy.nvim/commit/aa1c9572aa1916e582f9b9c3d43e272b4f23b326))
* **rocks:** dont trigger rebuild for luarocks when build is overriden ([146de4e](https://github.com/KurisuNya/lazy.nvim/commit/146de4e801f9169e79052a51365eaae789094611))
* **rocks:** hererocks paths on windows ([45cd8d3](https://github.com/KurisuNya/lazy.nvim/commit/45cd8d3f0fab197e6e0391cffa38879bdda4c2cd))
* **rocks:** only build rockspec when it has deps or an advanced build step ([9a6c219](https://github.com/KurisuNya/lazy.nvim/commit/9a6c21982638b6e2ea498514baee9186c0e60d82))
* **rockspec:** dont lazy-load rock deps ([4733611](https://github.com/KurisuNya/lazy.nvim/commit/473361139cc05936cd5afb08ab68e5bee1ebb5b3))
* **rocks:** windows ([4ca3e9a](https://github.com/KurisuNya/lazy.nvim/commit/4ca3e9aa51c03dda73b40ec9901deac5d4f11c69))
* **runner:** sync package specs after installing and before building ([105d480](https://github.com/KurisuNya/lazy.nvim/commit/105d4805ad58875d0b0fafe1185679539b8bc69a))
* small fix ([f548df2](https://github.com/KurisuNya/lazy.nvim/commit/f548df299a368679a8aec2f56a75ff946c903b75))
* **stats:** corrected typo in cputime() for Linux ([#916](https://github.com/KurisuNya/lazy.nvim/issues/916)) ([5082cd5](https://github.com/KurisuNya/lazy.nvim/commit/5082cd56e49c737619c967e9c57309c2eeaad425))
* **types:** fix incorrect LuaLS types ([#1339](https://github.com/KurisuNya/lazy.nvim/issues/1339)) ([5aea4e7](https://github.com/KurisuNya/lazy.nvim/commit/5aea4e7021287d7bcda6f31d7ad234580940be32))
* **types:** fixed type for `version`. Fixes [#1381](https://github.com/KurisuNya/lazy.nvim/issues/1381) ([eade87f](https://github.com/KurisuNya/lazy.nvim/commit/eade87fb837d6cdeef94587ce5e8c8dfb9f88920))
* **ui:** Add "bot" to dimmed commands list ([#1367](https://github.com/KurisuNya/lazy.nvim/issues/1367)) ([b6f7ef8](https://github.com/KurisuNya/lazy.nvim/commit/b6f7ef856b36c5edbe9f03e3a8554b97c458c953))
* **ui:** add conditional `nvim_get_hl_by_name` for Neovim 0.8.0 ([#1429](https://github.com/KurisuNya/lazy.nvim/issues/1429)) ([24234f4](https://github.com/KurisuNya/lazy.nvim/commit/24234f47a21ca690de829ea1159b553a733f3968))
* **ui:** close ui when opening a help file. Fixes [#808](https://github.com/KurisuNya/lazy.nvim/issues/808) ([cc7a764](https://github.com/KurisuNya/lazy.nvim/commit/cc7a764aecec11c9598ccd442a6879eed4e85558))
* **ui:** deduplicate plugins when selecting multiple ([#1491](https://github.com/KurisuNya/lazy.nvim/issues/1491)) ([b77aaa0](https://github.com/KurisuNya/lazy.nvim/commit/b77aaa08cb5b178ed8662765caa41c70ff254a4c))
* **ui:** disable backdrop when Neovim is transparent ([0ccf031](https://github.com/KurisuNya/lazy.nvim/commit/0ccf0312270d2d976ec551a9034bf05720f2486b))
* **ui:** don' render extmarks for empty lines ([dbe0e29](https://github.com/KurisuNya/lazy.nvim/commit/dbe0e29d85e2769be6c9738c176ba6d8b0c6817a))
* **ui:** don't pad empty lines ([#768](https://github.com/KurisuNya/lazy.nvim/issues/768)) ([b00d6f7](https://github.com/KurisuNya/lazy.nvim/commit/b00d6f7102a3345704edb46cbabf2dfa21d78d24))
* **ui:** don't show output when it's the same as error ([e79805d](https://github.com/KurisuNya/lazy.nvim/commit/e79805d706f815a62467260cb307844c368c3dba))
* **ui:** fixed keymaps in debug view ([fb9795e](https://github.com/KurisuNya/lazy.nvim/commit/fb9795e49fcd45e99bf386c675fbca28d98bf0a6))
* **ui:** hover now opens repo url when no diff with main. Fixes [#1430](https://github.com/KurisuNya/lazy.nvim/issues/1430) ([4084506](https://github.com/KurisuNya/lazy.nvim/commit/40845063a2586b725d84d44e41fe2c8737751a30))
* **ui:** issue with rendering empty lines. Fixes [#770](https://github.com/KurisuNya/lazy.nvim/issues/770) ([98ba47e](https://github.com/KurisuNya/lazy.nvim/commit/98ba47efedc4a29d2258fe80434d87bf5f72baa2))
* **ui:** make progress bar work again ([efa02ff](https://github.com/KurisuNya/lazy.nvim/commit/efa02ff8d37fe5809ea7826f11730a59d25533ef))
* **ui:** only enable backdrop when guicolors is set. Fixes [#1387](https://github.com/KurisuNya/lazy.nvim/issues/1387) ([d37a76b](https://github.com/KurisuNya/lazy.nvim/commit/d37a76b87137c777f3d778ed03729d7f332a85f0))
* **ui:** properly cleanup on `:quit`. Fixes [#1385](https://github.com/KurisuNya/lazy.nvim/issues/1385) ([79e2e85](https://github.com/KurisuNya/lazy.nvim/commit/79e2e8593410f199b85f5d61a83704a16169282f))
* **ui:** properly highlight breaking change commit scope ([#1160](https://github.com/KurisuNya/lazy.nvim/issues/1160)) ([3674036](https://github.com/KurisuNya/lazy.nvim/commit/3674036a59a6a4a65559343d606a92145a782533))
* **ui:** remove a single space character from home title ([#1309](https://github.com/KurisuNya/lazy.nvim/issues/1309)) ([d5c58bb](https://github.com/KurisuNya/lazy.nvim/commit/d5c58bb1937f8aee390f206e724ef23b0cc95eb3))
* **ui:** running tasks are now less twitchy ([7613ab2](https://github.com/KurisuNya/lazy.nvim/commit/7613ab2abb1bd99e039ae02030bc2c48b7626925))
* **ui:** set backdrop filetype to `lazy_backdrop`. Fixes [#1399](https://github.com/KurisuNya/lazy.nvim/issues/1399) ([31ddbea](https://github.com/KurisuNya/lazy.nvim/commit/31ddbea7c10b6920c9077b66c97951ca8682d5c8))
* **ui:** set wo options with local. don't use `vim.wo`. See [#829](https://github.com/KurisuNya/lazy.nvim/issues/829) ([7f4da7d](https://github.com/KurisuNya/lazy.nvim/commit/7f4da7d511b05f4571ea96c67a5988b6389e12e1))
* **ui:** setup colors when loading a float ([dbb2b60](https://github.com/KurisuNya/lazy.nvim/commit/dbb2b609f66486251b51c79a7a1d275887413e8e))
* **ui:** sort lazy plugin handlers ([ad5da0a](https://github.com/KurisuNya/lazy.nvim/commit/ad5da0ae20beca5dd89cb17c515c237c46c37b1e))
* **ui:** sort plugins case insensitive ([4f27fc3](https://github.com/KurisuNya/lazy.nvim/commit/4f27fc33c4e0e81802f4afadbe350de93447ac1e))
* **ui:** special handling for floats closed before VimEnter. Seems that WinClosed events dont execute before that. Fixes [#1390](https://github.com/KurisuNya/lazy.nvim/issues/1390) ([eefb897](https://github.com/KurisuNya/lazy.nvim/commit/eefb8974d6a092da6e1631855e4288499b651fdd))
* **ui:** take border into account for window position. Fixes [#812](https://github.com/KurisuNya/lazy.nvim/issues/812) ([451f217](https://github.com/KurisuNya/lazy.nvim/commit/451f217e9b2d71f08bdae0ce5ac7e8e8a6503f48))
* **ui:** trailing space in button row. Fixes [#884](https://github.com/KurisuNya/lazy.nvim/issues/884) ([410a736](https://github.com/KurisuNya/lazy.nvim/commit/410a7360c1b8df2053ae7ba906ff74c9072e1505))
* **ui:** use actual handler values for rendering plugin handlers ([99ee284](https://github.com/KurisuNya/lazy.nvim/commit/99ee28473962d9ab8aa11db2d2cc201e38f0f432))
* **ui:** use correct keymap for display. Fixes [#1089](https://github.com/KurisuNya/lazy.nvim/issues/1089) ([26762c9](https://github.com/KurisuNya/lazy.nvim/commit/26762c97e6dc3fddf141db0e82d044ee73e5f78d))
* update to new treesitter capture groups ([#1294](https://github.com/KurisuNya/lazy.nvim/issues/1294)) ([298bed1](https://github.com/KurisuNya/lazy.nvim/commit/298bed190e40b67bb1c20c4d5845c2c0c7da450f))
* use vim.iter():flatten():totable() over vim.tbl_flatten ([#1454](https://github.com/KurisuNya/lazy.nvim/issues/1454)) ([d039aec](https://github.com/KurisuNya/lazy.nvim/commit/d039aecddb414c2df9d295e9182ed217196a2c1c))
* **util:** dump ([025520d](https://github.com/KurisuNya/lazy.nvim/commit/025520d083c61baa7cd1f45807f5fe1ac9fbb50d))
* **util:** Util.merge now skips nil args ([70f764b](https://github.com/KurisuNya/lazy.nvim/commit/70f764bf735f74aed795188aeb8e57ccae0ae94e))
* uv shim was not falling back to vim.loop ([#1370](https://github.com/KurisuNya/lazy.nvim/issues/1370)) ([61dddae](https://github.com/KurisuNya/lazy.nvim/commit/61dddaec58f8594e40e95a8d5069ce7e493089df))
* **view:** backward compat for older Neovim versions. Fixes [#1489](https://github.com/KurisuNya/lazy.nvim/issues/1489) ([917dfbe](https://github.com/KurisuNya/lazy.nvim/commit/917dfbe2a9b606443639d1e809f2e4561a6dd654))


### Performance Improvements

* lazy require commands ([f0cfbf9](https://github.com/KurisuNya/lazy.nvim/commit/f0cfbf995238a42064e119bd1daa694fd1683ea3))
* minimize meta rebuild when loading specs ([1446f6c](https://github.com/KurisuNya/lazy.nvim/commit/1446f6cfbb4ca0a7ee0baf3acc86ab5e4be5ab22))
* **plugin:** cache lazy handler values ([c1b9887](https://github.com/KurisuNya/lazy.nvim/commit/c1b98873730d7121fec6a2f732b2083cd2cd62bf))
* **util:** don't try to load nvim-treesitter when markdown parser is builtin ([8b73492](https://github.com/KurisuNya/lazy.nvim/commit/8b73492249100d8a9ce9d874f7ea5a71b4d6f07e))
